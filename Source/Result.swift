...
public enum Result<Value> {
    ...
    // Chains another Result to this one. In the event that this Result is a .Success, the provided
    // transformer closure is used to generate another Result (wrapping a potentially new type). 
    ...
    // Chains another Result to this one. In the event that this Result is a .Success, the provided
    // transformer closure is used to transform the value into another value (of a potentially new type) 
    // and a new Result is made from that value. In the event that this Result is a .Failure, 
    // the next Result will have the same error as this one.
